...
export default function MindSkillsContent({ categorySlug }: ContentProps) {
  ...
  if (loading) {
    return <p className="text-gray-500 text-center p-10">در حال بارگذاری...</p>;
  }
          ...
          {subCategories.map((sub) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href={`/courses/${categorySlug}/${subSlug}`}
